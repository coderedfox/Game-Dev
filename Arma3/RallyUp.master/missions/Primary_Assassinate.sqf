...
if (!isServer) exitwith {};
	...
	// Find Tasking Location
		_Target_Location = [_TaskingPosition,_minDistance,_maxDistance,RallyUp_LocationsLocal,5] call RallyUp_fnc_position_Locations;
		if (_Target_Location distance2d _TaskingPosition > _maxDistance) exitWith {hint str ["RallyUpDiag : Mission outside of _maxDistance"];true};;
