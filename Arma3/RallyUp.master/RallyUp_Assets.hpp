...
// ---------------------------------------------------------------------
		...
		// Sets the default min and max mission range. Missions may override this value
			RallyUp_minDistance = 750; // Minimum Mission distance
			RallyUp_maxDistance = 1500; // Maximum Mission distance
		...
		// Mission names
			...
			RallyUp_MissionsSecondary = [
				...
				"Secondary_RewardHelicopter","Secondary_RewardJet"	
			];	
...
// ---------------------------------------------------------------------	
	...
	// List of possible Intel items for the search missions ["class name"]
		RallyUp_Intels = ["Land_Laptop_device_F","Land_PortableLongRangeRadio_F","Land_MobilePhone_smart_F","Land_File1_F","Land_File2_F","Land_FilePhotos_F","Land_Map_F","Land_DataTerminal_01_F","Land_Suitcase_F","Land_HandyCam_F","Land_Laptop_F","Land_Laptop_unfolded_F",		
			"Land_SatellitePhone_F","Land_Laptop_device_F","Land_PaperBox_open_full_F"
		];
