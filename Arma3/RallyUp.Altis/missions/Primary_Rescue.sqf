...
if (!isServer) exitwith {};
	...
	// Find Tasking Location		
		...
		_Hostage_Location = [position player,RallyUp_minDistance,RallyUp_maxDistance] call RallyUp_fnc_position_LocationsBuilding;
			if (_Hostage_Location distance2d _TaskingPosition > RallyUp_maxDistance) exitWith {diag_log ["RallyUpDiag : Mission outside of RallyUp_maxDistance"];true};	// Will cancel if the task to to far away	
		...
		_Rescue_Location = [_Hostage_Location,RallyUp_minDistance,RallyUp_maxDistance] call RallyUp_fnc_position_LocationsBuilding;
