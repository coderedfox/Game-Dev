/*
	...
	Usage: [array] call RallyUp_fnc_Position_2dCenter;
	Example : [allunits] call RallyUp_fnc_Position_2dCenter;
...
*/
	...
	_thisScript = _mathmeanpos;
	
// RETURN ------------------------------
diag_log format ["RallyUp : RallyUp_fnc_Position_2dCenter | _POSITIONRETURN = %1",_POSITIONRETURN];		
_POSITIONRETURN
